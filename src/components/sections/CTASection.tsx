    ...
    <section className="relative overflow-hidden bg-dark py-16 md:py-20">
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Link
            href="/contact"
            className="btn-premium btn-orange-to-black inline-flex items-center gap-2 rounded-xl px-8 py-4 text-base font-bold shadow-lg shadow-brand-orange/20"
          >
          ...
          {/* <a
            ...
            className="btn-premium btn-whatsapp-fill inline-flex items-center gap-2 rounded-xl px-8 py-4 text-base font-bold"
          >
            <svg 
              className="h-5 w-5 fill-current transition-colors duration-300" 
              viewBox="0 0 24 24" 
