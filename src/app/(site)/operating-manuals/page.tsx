...
import { OPERATING_MANUALS, type OperatingManualItem } from '@/lib/data/operating-manuals'
...
export default function OperatingManualsPage() {
  ...
  const categories = useMemo(() => {
    const cats = ['All', ...Array.from(new Set(OPERATING_MANUALS.map(d => d.category)))]
    return cats
  }, [])

  // Filter manuals based on search and category
  const filteredManuals = useMemo(() => {
    return OPERATING_MANUALS.filter(item => {
  ...
  const groupedManuals = useMemo(() => {
    const groups: Record<string, { category: string; items: OperatingManualItem[] }> = {}
  ...
  return (
    <main className="min-h-screen bg-white">
      <PageHeroSection 
        ...
        description="Access comprehensive operating and instruction manuals for our complete range of process control instruments."
        breadcrumbs={[
          { label: 'Operating Manuals' }
        ]}
        tag="Resources"
      />
            ...
            <div className="flex-1">
              <div className="mb-8 flex items-center justify-between border-b border-gray-100 pb-4">
                <p className="text-sm font-medium text-gray-500">
                  Showing <span className="text-dark font-bold">{filteredManuals.length}</span> results
                </p>
              ...
              {paginatedItems.length > 0 ? (
                <div className="space-y-12">
                  {Object.entries(groupedManuals).map(([groupName, data]) => (
                          ...
                          >
                            <div>
                              ...
                              <p className="text-sm text-gray-500 line-clamp-2">
                                Operating manual for {item.series}.
                              </p>
                            </div>
                ...
                <div className="py-20 text-center bg-gray-50 rounded-[40px] border border-dashed border-gray-200">
                  ...
                  <h3 className="text-xl font-bold text-dark">No matching operating manuals</h3>
      ...
      <section className="bg-gray-50 py-20 lg:py-32">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <h2 className="text-4xl font-bold text-dark mb-6">Can&apos;t find the operating manual you need?</h2>
          <p className="text-xl text-gray-600 mb-10 leading-relaxed">Our technical team can provide you with the exact specifications and manuals for any of our custom process control solutions.</p>
