            ...
            <div className="space-y-6">
              ...
              {activeTab === 'applications' && (
                <div>
                  ...
                  <div className="mt-8 rounded-2xl bg-orange-50 border border-orange-100 p-6">
                    ...
                    <Link
                      href="/contact"
                      className="inline-flex items-center gap-2 rounded-xl bg-brand-orange px-5 py-2.5 text-sm font-bold text-white hover:bg-brand-orange-dark transition-colors"
                    >
              ...
              <div className="rounded-2xl border border-brand-orange/20 bg-dark p-5">
                ...
                <Link
                  ...
                  className="mb-3 flex w-full items-center justify-center gap-2 rounded-xl bg-brand-orange px-4 py-3 text-sm font-bold text-white hover:bg-brand-orange-dark transition-colors"
                >
                ...
                <a
                  ...
                  className="mb-3 flex w-full items-center justify-center gap-2 rounded-xl border border-white/20 px-4 py-2.5 text-sm font-semibold text-white hover:border-white/40 transition-colors"
                >
                  WhatsApp Us
                </a>
                <a
